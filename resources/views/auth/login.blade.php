            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card mt-4">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                <h5 class="text-primary">{{ __('Welcome to Dinsides Courier!') }}</h5>
                                <p class="text-muted">{{ __('Sign in to continue to Dinsides Courier') }}</p>
                            </div>
                            <div class="p-2 mt-4">
                                <form action="{{ route('login') }}" method="POST">
                                    @csrf
                                    <div class="mb-3">
                                        <label for="username" class="form-label">{{ __('Email') }} <span class="text-danger">*</span></label>
                    ...
                    <div class="mt-4 text-center">
                        <p class="mb-0">{{ __('Don\'t have an account?') }} <a href="/register" class="fw-semibold text-primary text-decoration-underline"> {{ __('Register') }} </a> </p>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <p class="mb-0 text-muted">&copy; <script>document.write(new Date().getFullYear())</script> Dinsides Courier. <i class="mdi mdi-heart text-danger"></i> by AleBx</p>
                    </div>
                </div>
            </div>
        </div>
