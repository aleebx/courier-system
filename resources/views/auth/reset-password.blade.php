            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="p-2">
                                ...
                                @csrf
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div id="passwordInput" class="form-text">Debe tener al menos 8 caracteres.</div>
                                    </div>

                                    <div class="mb-3">
                                        <label class="form-label" for="confirm-password-input">Confirmar Contraseña</label>
                                        <div class="position-relative auth-pass-inputgroup mb-3">
                                            <input type="password" class="form-control pe-5 password-input" onpaste="return false" id="password_confirmation" name="password_confirmation" placeholder="Confirm password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
                                    ...
                                    <div id="password-contain" class="p-3 bg-light mb-2 rounded">
                                        ...
                                        <p id="pass-lower" class="invalid fs-12 mb-2">Al menos una <b>minuscula</b> (a-z)</p>
                                        <p id="pass-upper" class="invalid fs-12 mb-2">Al menos una <b>mayuscula</b> (A-Z)</p>
                                        <p id="pass-number" class="invalid fs-12 mb-0">Al menos un <b>numero</b> (0-9)</p>
                                    </div>
                                    ...
                                    <div class="mt-4">
                                        <button class="btn btn-success w-100" type="submit">Restablecer la contraseña</button>
                                    </div>
                    ...
                    <div class="mt-4 text-center">
                        <p class="mb-0">Espera, recuerdo mi contraseña... <a href="login" class="fw-semibold text-primary text-decoration-underline"> Haz clic aquí </a> </p>
                    </div>
