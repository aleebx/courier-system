                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                                ...
                                <div class="p-2">
                                    <form method="POST" action="{{ route('password.email') }}">
                                        ...
                                        <div class="text-center mt-4">
                                            <button class="btn btn-success w-100" type="submit">Enviar correo</button>
                                        </div>
                                    </form><!-- end form -->
                                </div>
                            </div>
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">Espera, recuerdo mi contraseña... <a href="login"
                                    class="fw-semibold text-primary text-decoration-underline"> Haz clic aquí </a> </p>
                        </div>
